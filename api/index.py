...
try:
    ...
    from app import app as flask_app, supabase
    
    # Configura Flask para servir arquivos estáticos corretamente no Vercel
    flask_app.static_folder = os.path.join(root_dir, 'templates', 'static')
