...
CREATE TABLE IF NOT EXISTS transactions (
    id TEXT PRIMARY KEY,
    tipo TEXT NOT NULL CHECK (tipo IN ('receita', 'debito', 'mercado_pago', 'nubank', 'itau')),
...
CREATE TABLE IF NOT EXISTS abatimentos (
    id TEXT PRIMARY KEY,
    tipo_cartao TEXT NOT NULL CHECK (tipo_cartao IN ('mercado_pago', 'nubank', 'itau')),
    valor DECIMAL(10, 2) NOT NULL,
    data DATE NOT NULL,
    descricao TEXT,
    created_at TIMESTAMP WITH TIME ZONE DEFAULT NOW()
...
-- Tabela de dinheiro guardado (reserva — valor único editável)
